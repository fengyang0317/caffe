...
modelFile='../../examples/pose/posenet_train_iter_10000.caffemodel';
dims = [256 256];
...
net1 = caffe.Net(modelDefFile, ...
    '../../examples/pose/posenet_train_iter_20000.caffemodel', 'test');
