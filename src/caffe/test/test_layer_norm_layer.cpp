...
namespace caffe {
  ...
  class LayerNormLayerTest : public MultiDeviceTest<TypeParam> {
   ...
   protected:
    ...
    virtual ~LayerNormLayerTest() { delete blob_bottom_; delete blob_top_; }
  ...
  TYPED_TEST_CASE(LayerNormLayerTest, TestDtypesAndDevices);

  TYPED_TEST(LayerNormLayerTest, TestForward) {
    typedef typename TypeParam::Dtype Dtype;
    LayerParameter layer_param;

    LayerNormLayer<Dtype> layer(layer_param);
  ...
  TYPED_TEST(LayerNormLayerTest, TestForwardInplace) {
    typedef typename TypeParam::Dtype Dtype;
  ...
  TYPED_TEST(LayerNormLayerTest, TestGradient) {
    typedef typename TypeParam::Dtype Dtype;
    LayerParameter layer_param;
