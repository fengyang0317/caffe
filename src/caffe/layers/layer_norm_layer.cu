...
void LayerNormLayer<Dtype>::Forward_gpu(const vector<Blob<Dtype>*>& bottom,
  ...
  // compute mean
  caffe_gpu_gemv<Dtype>(CblasNoTrans, num, spatial_dim,
...
template <typename Dtype>
void LayerNormLayer<Dtype>::Backward_gpu(const vector<Blob<Dtype>*>& top,
  ...
  caffe_gpu_gemv<Dtype>(CblasNoTrans, num, spatial_dim, 1.,
...
INSTANTIATE_LAYER_GPU_FUNCS(LayerNormLayer);
